...
**Status:** accepted (2026-05-30); частично заменён [ADR-0007](0007-v31-single-vps-alignment.md) (2026-06-30)

> **Обновление (v3.1).** Появился стандарт v3.1 single-VPS baseline: single-VPS теперь **baseline стандарта**,
> а не отклонение (пункты про «2 backend VM + ALB» ниже неактуальны). Актуальная раскладка/деплой и итоговый
> список отклонений — в [ADR-0007](0007-v31-single-vps-alignment.md) (по эталону EstiMat). Standalone auth,
> отсутствие Sentry SDK и реального email-провайдера остаются осознанными отклонениями этапа 1.
